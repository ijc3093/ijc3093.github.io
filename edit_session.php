<?php
    ...
    if($_SESSION['userRole'] == 2 || $_SESSION['userRole'] == 1){
        $result = $db->get_Manager_museais($_SESSION['idmuseai']);
                                ...
                                <?php
                                        ...
                                        echo'<form action="" method="post" role="form">';
                                            ...
                                            echo'<div class="form-group row">';
                                                    ...
                                                    echo '<br><br><a href="museais.php?back=true" class="btn btn-secondary" class="form-control" value="Cancel" required>Back</a>
