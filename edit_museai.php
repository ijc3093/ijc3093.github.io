<?php
    ...
    if(isset($_POST['edit'])){
        ...
        $hold = $db->update_museai($_POST['name'], $_POST['datestart'],  $_POST['dateend'] , $_POST['numberAllowed'], $_POST['dropdown'] , $_POST['id'] );
        // var_dump($hold);
        if($hold){
            echo "<script>alert('museai updated');</script>";
        }else{
            echo "<script>alert('museai failed to save');</script>";
        }
    }
    ...
    function back(){
        ...
        header("location: http://127.0.0.1:8080/museai.php");
        exit();
    }
?>
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Edit museai</a>
